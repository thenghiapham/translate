...
local en_dict_file = dir .. "dict.30000.en"
local fr_dict_file = dir .. "dict.30000.fr"
...
--local top_en_dict = Vocab.top(en_dict,30000)
--Vocab.save(top_en_dict, dir .. "dict.30000.en")
--
--local fr_dict = Vocab.create_dictionary(fr_tok)
--local top_fr_dict = Vocab.top(fr_dict,30000)
--Vocab.save(top_fr_dict, dir .. "dict.30000.fr")
